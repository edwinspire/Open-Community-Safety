...
function create_each_block(ctx) {
	...
	let t2;
	let t3;
	let t4_value = new Date(/*dateevent*/ ctx[9]).toLocaleTimeString() + "";
	let t4;
	let t5;
	let div13;
	let div4;
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			...
			if (dirty & /*promise*/ 1 && t4_value !== (t4_value = new Date(/*dateevent*/ ctx[9]).toLocaleTimeString() + "")) Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["set_data_dev"])(t4, t4_value);
